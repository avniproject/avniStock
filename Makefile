...
upload-prod-apk:
	@aws s3 cp --acl public-read android/app/build/outputs/apk/release/app-release.apk s3://samanvay/openchs/prod-apks/avni-stock-prod-$(sha)-$(dat).apk
	@echo "APK Available at https://s3.ap-south-1.amazonaws.com/samanvay/openchs/prod-apks/avni-stock-prod-$(sha)-$(dat).apk"
